...
from backend.resources.bookmark import LinkBookmarkToUser
from backend.resources.news import NewsResource, NewsById
from backend.resources.rating import RateArecipe
from backend.resources.review import LinkingReviewtoRecipe, UpdateReview
